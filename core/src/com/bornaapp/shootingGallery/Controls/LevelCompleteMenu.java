...
public class LevelCompleteMenu {
    ...
    public void Init() {
        ...
        continueBtnSkin.addRegions(currentLevel.assets.getTextureAtlas("ContinueBtn.atlas"));
...
//        table.debugAll();
        ...
        final Drawable tblBackground = new TextureRegionDrawable(new TextureRegion(currentLevel.assets.getTexture("levelCompleteTable.png")));
